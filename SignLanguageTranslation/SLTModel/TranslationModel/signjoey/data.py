...
def read_gloss_vocab(data_cfg: dict) -> (Vocabulary, Vocabulary):
...
def load_test_data(data_cfg: dict, test_path, gls_vocab, txt_vocab) -> (Dataset):
    """
    das
    """

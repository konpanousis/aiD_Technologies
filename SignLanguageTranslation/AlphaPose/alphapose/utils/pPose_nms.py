...
def write_json(all_results, outputpath, form=None, for_eval=False, outputfile='alphapose-results.json', text = 'Unknown', signer = '', gloss = '' ):
    '''
    all_result: result dict of predictions
    outputpath: output directory
    '''
    json_results = []
    json_results.append({'text':text})
    json_results.append({'signer':signer})
    json_results.append({'gloss':gloss})
    json_results_cmu = {}
